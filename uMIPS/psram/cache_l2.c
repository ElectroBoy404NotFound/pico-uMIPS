...
// #define psram_write(handle, ofs, p, sz) cache_write_l3(ofs, p, sz)
// #define psram_read(handle, ofs, p, sz) cache_read_l3(ofs, p, sz)
...
void cache_write_l2(uint32_t ofs, void *buf, uint32_t size)
{
...
void cache_read_l2(uint32_t ofs, void *buf, uint32_t size)
{
	// if (((ofs | (64 - 1)) != ((ofs + size - 1) | (64 - 1))))
